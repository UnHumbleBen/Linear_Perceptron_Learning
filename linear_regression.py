...
def experiment(number_of_training_points):
    ...
    number_incorrect_in_sample = 0
    for input in data_set_x:
        f_value = target_function(input)
        g_value = g_function(input)
        if f_value != g_value:
            number_incorrect_in_sample += 1
    fraction_in_sample = number_incorrect_in_sample / number_of_training_points
...
for _ in range(number_of_experiments):
    experiment_results = experiment(number_of_training_points)
...
print([avg_fraction_in, avg_fraction_out, avg_iterations])

# testing
# print("output y: " + str(data_set_y))
# print("matrix form y: " + str(y_matrix))
# print(data_set_x)
# print(x_matrix)
